...
class InfinitLayoutManager : RecyclerView.LayoutManager, RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     */
    public var smoothScrollDirectionDecider: (Int, InfinitLayoutManager, Int) -> Int = ::defaultDecider
    ...
    public override fun generateDefaultLayoutParams(): RecyclerView.LayoutParams {
    ...
    public fun findViewByPosition(
        adapterIndex: Int,
        strategy: (targetIndex: Int, layoutManager: InfinitLayoutManager) -> View?
    ): View? {
    ...
    public fun scrollToPosition(
        ...
        strategy: (
            targetIndex: Int,
            layoutManager: InfinitLayoutManager,
            itemCount: Int
        ) -> Int
    ) {
    ...
    private inner class LoopingSmoothScroller(
        ...
        public override fun onStart() {
            ...
            val time = 500  // MS.
            (layoutManager as InfinitLayoutManager).extraLayoutSpace = (rate * time).toInt()
        }
        ...
        public override fun onStop() {
            (layoutManager as InfinitLayoutManager).extraLayoutSpace = 0
        }

        public override fun computeScrollVectorForPosition(targetPosition: Int): PointF? {
            val layoutManager = layoutManager  // Enables smart cast.
            if (layoutManager is InfinitLayoutManager) {
    ...
    private class LayoutRequest() : Parcelable {
         ...
         */
        private var scrollStrategy: ((Int, InfinitLayoutManager, Int) -> Int)? = null
        ...
        public constructor(
            ...
            scrollStrategy: ((Int, InfinitLayoutManager, Int) -> Int)? = null,
            layoutManager: InfinitLayoutManager? = null,
         ...
         */
        public fun initialize(layoutManager: InfinitLayoutManager, state: RecyclerView.State) {
    ...
    private fun calculateDistances(adapterIndex: Int, anchorIndex: Int, count: Int): Pair<Int, Int> {
     ...
     */
    private fun childClosestToMiddle(
        targetAdapterIndex: Int,
        layoutManager: InfinitLayoutManager
    ): View? {
    ...
    companion object {
        ...
        private const val TAG = "InfinitLayoutManager"
